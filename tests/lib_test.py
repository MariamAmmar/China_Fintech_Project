...
import os
import China_Fintech_Project
import pandas as pd
# Import from our lib
from China_Fintech_Project.lib import clean_data
import pytest


def test_clean_data():
    datapath = os.path.dirname(os.path.abspath(China_Fintech_Project.__file__)) + '/data'
